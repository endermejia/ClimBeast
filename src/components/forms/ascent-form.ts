      ...
      try {
        if (this.isIndoor()) {
          const payload = {
            ...
            recommended: otherValues.recommended || false,
            grade: otherValues.grade === 0 ? null : otherValues.grade,
          ...
          if (ascentData) {
            ...
            const res = await this.indoorService.createRouteAscent(payload);
            savedAscentId = res.id;
          }
